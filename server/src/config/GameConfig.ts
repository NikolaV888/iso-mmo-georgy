...
export const GameConfig = {
    ...
    SKILL_POWER_STRIKE_COOLDOWN_MS: 3200,
    SKILL_POWER_STRIKE_RANGE_BONUS: 0.35,
    SKILL_POWER_STRIKE_DAMAGE_MULTIPLIER: 1.8,
    SKILL_POWER_STRIKE_BONUS_DAMAGE: 4,
    SKILL_RISING_UPPERCUT_COOLDOWN_MS: 5200,
    SKILL_RISING_UPPERCUT_RANGE_BONUS: 0.2,
    SKILL_RISING_UPPERCUT_DAMAGE_MULTIPLIER: 1.25,
    SKILL_RISING_UPPERCUT_BONUS_DAMAGE: 3,
    SKILL_RISING_UPPERCUT_IMPULSE: 6.1,
    SKILL_GUARDIAN_PULSE_COOLDOWN_MS: 9000,
    SKILL_GUARDIAN_PULSE_HEAL_AMOUNT: 32,
